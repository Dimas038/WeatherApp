...
public abstract class HeaderFooterRecyclerViewAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public final T onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        } catch (BaseViewHolder.AdapterLostException ignored) {
        }
     ...
     */
    @Override
    public final void onBindViewHolder(T viewHolder, int position) {
        try {
            // Delegate to proper methods based on the viewType ranges.
...
//    @Override
//    public final void onViewRecycled(T viewHolder) {
//        // Delegate to proper methods based on the viewType ranges.
////        if (headerItemCount > 0 && viewHolder.getAdapterPosition() < headerItemCount) {
////            onHeaderItemViewRecycled(viewHolder, viewHolder.getAdapterPosition());
////        } else if (contentItemCount > 0 && viewHolder.getAdapterPosition() - headerItemCount < contentItemCount) {
////            onContentItemViewRecycled(viewHolder, viewHolder.getAdapterPosition() - headerItemCount);
////        } else {
////            onFooterItemViewRecycled(viewHolder, viewHolder.getAdapterPosition() - headerItemCount - contentItemCount);
////        }
//    }
     ...
     */
    protected abstract T onCreateHeaderItemViewHolder(ViewGroup parent, int headerViewType) throws BaseViewHolder.AdapterLostException;
     ...
     * @return the view holder.
     */
    protected abstract T onCreateFooterItemViewHolder(ViewGroup parent, int footerViewType);
     ...
     * @return the view holder.
     */
    protected abstract T onCreateContentItemViewHolder(ViewGroup parent, int contentViewType);

    /**
     * This method works exactly the same as {@link #onBindViewHolder(T, int)}, but for header items.
     *
     * @param viewHolder the view holder for the header item.
     * @param position   the position.
     */
    protected abstract void onBindHeaderItemViewHolder(T viewHolder, int position) throws BaseViewHolder.AdapterLostException;

    /**
     * This method works exactly the same as {@link #onBindViewHolder(T, int)}, but for footer items.
     *
     * @param viewHolder the view holder for the footer item.
     * @param position   the position.
     */
    protected abstract void onBindFooterItemViewHolder(T viewHolder, int position) throws BaseViewHolder.AdapterLostException;

    /**
     * This method works exactly the same as {@link #onBindViewHolder(T, int)}, but for content items.
     *
     * @param contentViewHolder the view holder for the content item.
     * @param position          the position.
     */
    protected abstract void onBindContentItemViewHolder(T contentViewHolder, int position) throws BaseViewHolder.AdapterLostException;

//    protected abstract void onHeaderItemViewRecycled(T viewHolder, int position);
//
//    protected abstract void onFooterItemViewRecycled(T viewHolder, int position);
//
//    protected abstract void onContentItemViewRecycled(T viewHolder, int position);

    public int getContentItemPosition(T viewHolder) {
        return viewHolder.getAdapterPosition() - getHeaderItemCount();
    }

    public int getFooterItemPosition(T viewHolder) {
