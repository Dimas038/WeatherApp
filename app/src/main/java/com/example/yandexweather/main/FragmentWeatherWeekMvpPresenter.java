...
@InjectViewState
public class FragmentWeatherWeekMvpPresenter extends MvpPresenter<FragmentWeatherWeekMvpView> {
    ...
    public FragmentWeatherWeekMvpPresenter(CoordinatesModel coordinatesModel, DayModel dayModel) {
